- `WEIN` accepts only **text files, either comma, semicolon, or tab-separated**. This avoids proprietary formats such as Excel, which can also inadvertently convert your gene identifiers to dates or floating point numbers (SEPT2, see more [here](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-1044-7))
...
- general reminder: if you launch `WEIN` directly from the terminal/RStudio IDE, you can pre-compute the objects, this can speed up
